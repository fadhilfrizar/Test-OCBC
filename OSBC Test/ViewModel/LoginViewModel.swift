...
class LoginViewModel {
    ...
    func login(username: String, password: String, indicator: UIActivityIndicatorView, view: UIView, viewController: UIViewController, emptyValidationUsername: UILabel, emptyValidationPassword: UILabel, loginButton: UIButton) {
